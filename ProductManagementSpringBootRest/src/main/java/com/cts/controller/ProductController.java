...
//	@Autowired
	...
	public String deleteProduct(@PathVariable("pid") int productId) throws ProductNotFoundException {
		return service.deleteProductById(productId);
	}

	@GetMapping("/fetch/{pid}") // http://localhost:8080:/products/fetch/123
	public Product getProduct(@PathVariable("pid") int productId) throws ProductNotFoundException {
	...
	public List<Product> getAllProductsByCategory(@PathVariable("category") String category) throws ProductCategoryNotFound {
